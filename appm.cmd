...
action setvariable tap $1 when ^In your right hand, you are carrying (.+)\.$
...
send inventory held
waitforre ^In your right hand
echo --------------------------------------------
echo Tap: %tap
echo Look: You see nothing unusual.
...
echo
echo Concise IC: This %weight1-stone shield offers roughly %sprotection protection at the expense of %shindrance hindrance. When used offensively, the %noun can inflict %impact impact damage, is %balance balanced, and is %power suited to taking advantage of your strength. It is %construct.
echo
