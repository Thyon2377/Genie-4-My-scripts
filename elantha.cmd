...
gosub VarBlank
pause 1
send look %1 $preposition $shop
pause .5
send read %1 $preposition $shop
pause .5
send appraise %1 $preposition $shop careful
wait
pause .5
...
put #log >Appraisal-$charactername.txt |noun=%1
...
echo |newapp2=Yes
echo |brawl=yes
echo |noun=%number %1 $preposition $shop
echo |look=%look
echo <br />'''Read''': %read
echo |MTag=%mtags, %mtagm, %mtagf, %mtagg, %mtagw
echo |CTag=%ctagr, %ctago, %ctagt, %ctagy, %ctagg, %ctagb, %ctagv, %ctagn, %ctagm, %ctagx
...
verbcheck:
send study %number %1 $preposition $shop
wait
pause .5
send analyze %number %1 $preposition $shop
wait
pause .5
send focus %number %1 $preposition $shop
wait
pause .5
return
