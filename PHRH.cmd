...
#%
#% Version 5.02
##You rummage through a belted kidskin baldric tooled with sinuous maiden's tress vines and see a glaes scimitar, a steel bastard sword, a braided firesilk sling embroidered with firebreathing dragons, a steel light spear, a steel greataxe, a hunk of dried yak dung, a bright green pinata stick shaped like a caterpillar, a haralun hawkbill, a bloodwood Nisha shortbow with laminated limbs, a dark glaes nightstick inlaid with thin platinum bands and a glaes bola.
...
#% example : Bow|Crossbow|Offhand_Weapon|Polearms|Slings|Small_Edged|Staves|Twohanded_Blunt|Small_Blunt|Large_Blunt|Brawling|Light_Thrown|Targeted_Magic|Large_Edged|Heavy_Thrown|Twohanded_Edged
     ...
     var crossbow stonebow
     var crossbow-ammo blunt stone
     ...
     var offhand nightstick
     var offhand-type melee
     var offhand-bond off
     var brawl on
     var brawl-maneuver pummel
...
#% These are 'if not mind locked by this many attacks move on to next skill' defaults.
     ...
     var smalledge-attack-limit 50
     var largeedge-attack-limit 60
     var twohandededge-attack-limit 50
     var smallblunt-attack-limit 90
     var largeblunt-attack-limit 90
     var twohandedblunt-attack-limit 90
     var staves-attack-limit 80
     var polearms-attack-limit 60
     var crossbow-attack-limit 60
     var bow-attack-limit 60
     var slings-attack-limit 60
     var lightthrown-attack-limit 90
     var heavythrown-attack-limit 90
     var offhand-attack-limit 150
...
#% STANCES  EVA PARRY SHIELD ATTACK
     ...
     var largeblunt-stance 80 100 0 100
     var twohandedblunt-stance 80 100 0 100
     var staves-stance 80 100 0 100
     var polearms-stance 100 80 0 100
     ...
     var backstab-stance 100 0 83 100
...
#% SPELL BUFFS
     var buff-spell-1 Athletic 10
     var buff-camb-1 0
	 var buff-spell-2 stw 10
     var buff-camb-2 0
     var buff-spell-3 EY 10
     var buff-camb-3 0
     var buff-spell-4 EM 10
     var buff-camb-4 0
     ...
     var buff-camb-10 0
     var minimum-attunement 60
     var camb-item cambrinth.ring
...
#% CONTAINERS
     ...
     var sheath-1-weapons bow|sickle|recade|mace|staff sling|bola|club|nightstick|shard|stone
     var sheath-2-name none
     var sheath-2-weapons none
     var sheath-3-name war belt
     var sheath-3-weapons throwing hammer|stonebow|Halberd|arrow|
...
put info
     ...
     var weaponnames %backstabber|%smalledge|%largeedge|%twohandededge|%smallblunt|%largeblunt|%twohandedblunt|%staves|%polearms|%crossbow|%bow|%slings|%heavythrown|%lightthrown|%offhand|%brawl|%tm-weapon|%modules
...
put get %thrown
     ...
     matchre %attack (You fade in|You get|You pick|You draw|already holding)
     matchwait
...
pause %PAUSE
put dissect
matchre DISSECT ^\.\.\.wait|^You are still stunned|^Sorry\,
matchre DISSECT_SHEATHE ^You must have one hand free
matchre LOOTDEAD ^Roundtime\:|You succeed in dissecting the corpse\.$|no insights from this attempt\.$
matchre DO_ARRANGE ^You do not yet possess the knowledge|not be useful to your understanding of First Aid\.$|^That\'d be a waste of time\.
matchwait 5
return
