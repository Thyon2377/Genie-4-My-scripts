...
var Playing 0
action var currentchart $1 when ^You turn to page \d+ of your $TextbookType, containing (.*) physiology\.
...
read:
put turn $TextbookType to %lowchart
pause 0.5
charts:
if %Playing = 0 then 
	{
...
put turn my $TextbookType to %charts(%chartnumber)
pause 0.5
goto charts
