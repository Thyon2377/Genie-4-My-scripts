ECHO STARTS OUTSIDE BANK IN CROSSING
...
ECHO  *** CRO.CLIMB ***
ECHO
	if $Athletics.LearningRate >= 30 then goto MIND.MURK
...
ECHO  *** MIND.CHECK ***
ECHO
	match MIND.MURK mind lock
	match MIND.MURK nearly locked
	match MIND.MURK rapt
	match CLIMB.EXP EXP HELP
	put exp athletic
	matchwait

MIND.MURK:
ECHO
ECHO  *** MIND MURKED UP - PAUSING! ***
ECHO
	put sleep
	put yawn
	pause 45
