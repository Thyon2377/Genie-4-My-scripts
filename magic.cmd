...
action var prepped 0 when ^With tense movements|^You begin chanting|your head skyward|^You raise your
...
if ($zoneid = 8) && ($roomid = 29) then goto start
if ($zoneid = 1) && ($roomid = 307) then goto start
if ($zoneid = 7) && ($roomid = 558) then goto start
if ($zoneid = 150) && ($roomid = 46) then goto start
goto travel
...
cast:
  ...
  matchre SUCCESS ^You clasp your hands together
  ...
  matchre SUCCESS ^You reach with both your hands
  matchre SUCCESS ^Your mind races 
  ...
  matchre SUCCESS ^You blend smoothly
...
mana.wait_1:
  ...
  echo 
  pause 5
  if !matchre("$scriptlist", "Compendium") then put .collect
  goto mana.wait_1
