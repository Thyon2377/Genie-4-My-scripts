...
echo
echo Verbose IC: This %wtype weapon can be thrown from missile range or wielded at %range range. It can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. The %noun %force improves the force of your attacks, is %balance balanced, and is %power suited to taking advantage of your strength. It weighs %weight1 %weight2 and is %construct.
echo
echo Concise IC: This %weight1-stone %noun can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It %force improves the force of your attacks, is %balance balanced, and is %power suited to taking advantage of your strength. It is %construct.
echo
echo OOC: %wtype (%weight1 %weight2): %puncture puncture/%slice slice/%impact impact, %force improves force/%balance balanced/%power suited, %construct
pause
goto exit
...
if "%force" = "not" then var force do not
echo
echo Verbose IC: These %noun are ammunition for a bow. When fired, they can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. They %force improve the force of your attacks. The %noun weigh %weight1 %weight2 and are %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. The %noun %force improve the force of your attacks. They weigh %weight1 %weight2 and are %construct.
echo
echo OOC: Bow ammunition (%weight1 %weight2): %puncture puncture/%slice slice/%impact impact, %force improve force, %construct
pause
goto exit
...
if "%force" = "not" then var force do not
echo
echo Verbose IC: These %noun are ammunition for a crossbow. When fired, they can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. They %force improve the force of your attacks. The %noun weigh %weight1 %weight2 and are %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. The %noun %force improve the force of your attacks. They weigh %weight1 %weight2 and are %construct.
echo
echo OOC: Crossbow ammunition (%weight1 %weight2): %puncture puncture/%slice slice/%impact impact, %force improve force, %construct
pause
goto exit
...
if "%force" = "not" then var force do not
echo
echo Verbose IC: These %noun are ammunition for a sling or staff sling. When hurled, they can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. They %force improve the force of your attacks. The %noun weigh %weight1 %weight2 and are %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. The %noun %force improve the force of your attacks. They weigh %weight1 %weight2 and are %construct.
echo
echo OOC: Sling ammunition (%weight1 %weight2): %puncture puncture/%slice slice/%impact impact, %force improve force, %construct
pause
goto exit
...
if "%force" = "not" then var force does not
echo
echo Verbose IC: This %noun is ammunition for a bow. When fired, it can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It %force improves the force of your attacks. The %noun weighs %weight1 %weight2 and is %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It weighs %weight1 %weight2 and is %construct.
echo
echo OOC: Bow ammunition (%weight1 %weight2): %puncture puncture/%slice slice/%impact impact, %force improves force, %construct
pause
goto exit
...
if "%force" = "not" then var force does not
echo
echo Verbose IC: This %noun is ammunition for a crossbow. When fired, it can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. The %noun weighs %weight1 %weight2 and is %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It weighs %weight1 %weight2 and is %construct.
echo
echo OOC: Crossbow ammunition (%weight1 %weight2): %puncture puncture/%slice slice/%impact impact, %construct
pause
goto exit
...
if "%force" = "not" then var force does not
echo
echo Verbose IC: This %noun is ammunition for a sling or staff sling. When hurled, it can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It %force improves the force of your attacks. The %noun weighs %weight1 %weight2 and is %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It weighs %weight1 %weight2 and is %construct.
echo
echo OOC: Sling ammunition (%weight1 %weight2): %puncture puncture/%slice slice/%impact impact, %force improves force, %construct
pause
goto exit
