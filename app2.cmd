...
echo
echo Verbose IC: This %wtype weapon can be thrown from missile range or wielded at %range range. It can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. The %noun %force improves the force of your attacks, is %balance balanced, and is %power suited to taking advantage of your strength. It is %construct.
echo
echo Concise IC: This %noun can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It %force improves the force of your attacks, is %balance balanced, and is %power suited to taking advantage of your strength. It is %construct.
echo
echo OOC: %wtype: %puncture puncture/%slice slice/%impact impact, %force improves force/%balance balanced/%power suited, %construct
pause
goto exit
...
if "%force" = "not" then var force does not
echo
echo Verbose IC: This %wtype weapon can be wielded at %range range. It can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. The %noun %force improves the force of your attacks, is %balance balanced, and is %power suited to taking advantage of your strength. It is %construct.
echo
echo Concise IC: This %noun can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It %force improves the force of your attacks, is %balance balanced, and is %power suited to taking advantage of your strength. It is %construct.
echo
echo OOC: %wtype: %puncture puncture/%slice slice/%impact impact, %force improves force/%balance balanced/%power suited, %construct
...
echo
echo Concise IC: This %stype shield offers %sprotection protection at the expense of %shindrance hindrance. When used offensively, the %noun can inflict %impact impact damage, is %balance balanced, and is %power suited to taking advantage of your strength. It is %construct.
echo
...
shield2:
echo
echo Verbose IC: This %stype shield offers roughly %sprotection protection at the expense of %shindrance hindrance to one's ability to maneuver in combat. When used offensively, the %noun can inflict %impact impact damage, is %balance balanced, and is %power suited to taking advantage of your strength. It is %construct.
echo
echo Concise IC: This %stype shield offers roughly %sprotection protection at the expense of %shindrance hindrance. When used offensively, the %noun can inflict %impact impact damage, is %balance balanced, and is %power suited to taking advantage of your strength. It is %construct.
echo
echo OOC: %stype shield: roughly %sprotection protection, %shindrance hindrance, %construct
pause
goto exit
...
if "%force" = "not" then var force do not
echo
echo Verbose IC: These %noun are ammunition for a bow. When fired, they can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. They %force improve the force of your attacks. The %noun are %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. The %noun %force improve the force of your attacks. They are %construct.
echo
echo OOC: Bow ammunition: %puncture puncture/%slice slice/%impact impact, %force improve force, %construct
pause
goto exit
...
if "%force" = "not" then var force do not
echo
echo Verbose IC: These %noun are ammunition for a crossbow. When fired, they can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. They %force improve the force of your attacks. The %noun are %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. The %noun %force improve the force of your attacks. They are %construct.
echo
echo OOC: Crossbow ammunition: %puncture puncture/%slice slice/%impact impact, %force improve force, %construct
pause
goto exit
...
if "%force" = "not" then var force do not
echo
echo Verbose IC: These %noun are ammunition for a sling or staff sling. When hurled, they can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. They %force improve the force of your attacks. The %noun are %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. The %noun %force improve the force of your attacks. They are %construct.
echo
echo OOC: Sling ammunition: %puncture puncture/%slice slice/%impact impact, %force improve force, %construct
pause
goto exit
...
if "%force" = "not" then var force does not
echo
echo Verbose IC: This %noun is ammunition for a bow. When fired, it can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It %force improves the force of your attacks. The %noun is %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It is %construct.
echo
echo OOC: Bow ammunition: %puncture puncture/%slice slice/%impact impact, %force improves force, %construct
pause
goto exit
...
if "%force" = "not" then var force does not
echo
echo Verbose IC: This %noun is ammunition for a crossbow. When fired, it can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. The %noun is %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It is %construct.
echo
echo OOC: Crossbow ammunition: %puncture puncture/%slice slice/%impact impact, %construct
pause
goto exit
...
if "%force" = "not" then var force does not
echo
echo Verbose IC: This %noun is ammunition for a sling or staff sling. When hurled, it can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It %force improves the force of your attacks. The %noun is %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, and %impact impact damage. It is %construct.
echo
echo OOC: Sling ammunition: %puncture puncture/%slice slice/%impact impact, %force improves force, %construct
pause
goto exit
...
if "%force" = "not" then var force does not
echo
echo Verbose IC: This %wtype can be used from missile range. The %noun %force improves the force of your attacks, is %balance balanced, and is %power suited for adding attack power from its draw strength, which is %drawstrength for a bow of this type. It is %construct.
echo
echo Concise IC: This %noun %force improves the force of your attacks, is %balance balanced, and is %power suited for adding attack power from its draw strength, which is %drawstrength. It is %construct.
echo
echo OOC: %wtype: %force improves force, %balance balanced/%power suited, %drawstrength draw strength, %construct
pause
goto exit
