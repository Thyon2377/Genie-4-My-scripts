...
#% example : Bow|Crossbow|Offhand_Weapon|Polearms|Slings|Small_Edged|Staves|Twohanded_Blunt|Small_Blunt|Large_Blunt|Brawling|Light_Thrown|Targeted_Magic|Large_Edged|Heavy_Thrown|Twohanded_Edged
     ...
     var smalledge hairpin
     var largeedge bastard sword
     var twohandededge bastard sword
     var edge-maneuver none
     var smallblunt bola
     var largeblunt riste
     ...
     var heavythrown throwing mallet
     ...
     var targetmagic on
     var TM-spell-1 FST 5
     var TM-spell-2 STRA 7
     var TM-spell-3 none
     var TM-weapon none
...
#% Debil cast can be set to area, creature, a specific command like "malediction offense" or none for general debil casts.
     ...
     var debilitation on
     var debil-spell SF 3
     var debil-cast burden 3
     var debil-tatt none
...
#% STANCES  EVA PARRY SHIELD ATTACK
     ...
     var smalledge-stance 80 100 0 100
     var largeedge-stance 80 100 0 100
     var twohandededge-stance 80 100 0 100
     var smallblunt-stance 80 100 0 100
     var largeblunt-stance 80 100 100
     var twohandedblunt-stance 80 100 0 100 
     var staves-stance 20 100 60 100
     var polearms-stance 80 100 0 100
     var crossbow-stance 80 0 100 100
     var bow-stance 80 0 100 100
     var slings-stance 80 0 100 100
     var lightthrown-stance 80 0 100 100
     var heavythrown-stance 80 0 100 100
     var offhand-stance 80 0 100 100
     var brawl-stance 80 100 0 100
     var TM-stance 80 0 100 100
...
#% Necro Rituals
     ...
     var ritual-1 preserve	
     var ritual-2 dissection
     var ritual-3 none
     var necro-harvest off
     var necro-selfheal off
     var necro-heal-spell none
...
#% SPELL BUFFS
     ...
     var buff-camb-2 0
     var buff-spell-3 VOS 15
     var buff-camb-3 0
     var buff-spell-4 HES 15
     var buff-camb-4 0
     var buff-spell-5 AA 15
     var buff-camb-5 40
...
#% CONTAINERS
     ...
     var sheath-1-weapons hairpin|riste|shortbow|spear|staff sling|
                          fan|crossbow|bola|bastard sword|
     var sheath-2-name gearbag
     var sheath-2-weapons throwing mallet|Crossbow 
