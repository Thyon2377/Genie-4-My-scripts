...
action setvariable wearloc 20-elbow-w when ^It appears that the .+ can be worn strapped to the elbows\.$
...
action setvariable wearloc 23-parry when ^You are certain that the .+ is a purely defensive item\.$
action setvariable wearloc 24-hands-w when ^It appears that the .+ can be worn strapped to the hands\.$
...
action setvariable wearloc 33-knee-w when ^It appears that the .+ can be worn strapped to the knees\.$
action setvariable wearloc 34-ankle when ^It appears that .+ can be worn around the ankle\.$
action setvariable wearloc 35-feet-w when ^It appears that the .+ can be worn strapped to the feet\.$
...
echo 7:	Armor
echo
echo 8:	Cambrinth/Gaethzen
echo
echo 9:	Container (requires yardstick)
echo
...
echo
echo %appcostk	%sourcetype	%source	%wtype1	%wtrains	%range	%composition	%noun	%tap	%qpointsw	%qpointsww	%weight	%sumd	%sumpd	%sumed	%foi	%balance	%power	%construction	%puncture	%slice	%impact	%fire	%cold	%electric	$date
...
echo
echo %appcostk	%sourcetype	%source	%wtype2/%wtype1	%wtrains2/%wtrains	%range	%composition	%noun	%tap	%qpointsw	%qpointsww	%weight	%sumd	%sumpd	%sumed	%foi	%balance	%power	%construction	%puncture	%slice	%impact	%fire	%cold	%electric	$date
...
echo
echo %appcostk	%sourcetype	%source	%wtype1	%wtrains	%composition	%noun	%tap	%qpointsw	%qpointsww	%weight	%foi	%balance	%power	%drawstrength	%adjdraw	%sumd	%sumpd	%sumed	%construction	%puncture	%slice	%impact	%fire	%cold	%electric	$date
...
echo
echo %appcostk	%sourcetype	%source	%ammotype ammo	%ammoskill ammo	%composition	%noun	%tap	%qpointsw	%qpointsww	%weight	%foi	%balance	%power	%drawstrength	%adjdraw	%sumd	%sumpd	%sumed	%construction	%puncture	%slice	%impact	%fire	%cold	%electric	$date
put #log >ItemStats-%logtype-$charactername.txt %appcostk	%sourcetype	%source	%ammotype ammo	%ammoskill ammo	%composition	%noun	%tap	%qpointsw	%qpointsww	%weight	%foi	%balance	%power	%drawstrength	%adjdraw	%sumd	%sumpd	%sumed	%construction	%puncture	%slice	%impact	%fire	%cold	%electric	$date
put #log >ItemStatsReader-%logtype-$charactername.txt Stats for %tap
put #log >ItemStatsReader-%logtype-$charactername.txt @
...
echo
echo %appcostk	%sourcetype	%source	15-brawl-%brawltype	11-brawl-%brawltype	%range	%composition	%noun	%tap	%qpointsw	%qpointsww	%weight	%sumd	%sumpd	%sumed	%foi	%balance	%power	%construction	%puncture	%slice	%impact	%fire	%cold	%electric	$date
...
echo
echo %appcostk	%sourcetype	%source	15-brawl-1parry	11-brawl-1parry	%range	%composition	%noun	%tap	%qpointsw	%qpointsww	%weight	%sumd	%sumpd	%sumed	%foi	%balance	%power	%construction	%puncture	%slice	%impact	%fire	%cold	%electric	$date
...
echo
echo %appcostk	%sourcetype	%source	%stype	%composition	%noun	%tap	%qpointss	%qpointssw	%weight	%sumshield	%smin	%smax	%shdhindrance	%construction	%impact	%balance	%power	$date
...
echo
echo %appcostk	%sourcetype	%source	%atype	%area	%composition	%noun	%tap	%qpointsa	%qpointsaw	%weight	%sumdef	%sumpro	%sumabs	%sumpdef	%sumedef	%mhindrance	%shindrance	%construction	%sumhin	%puncturep	%puncturea	%slicep	%slicea	%impactp	%impacta	%firep	%firea	%coldp	%colda	%electricp	%electrica	$date
...
echo Stats for %tap
echo
echo mana capacity: %maxcharge
echo wear location: %wearloc
echo weight: %weight
echo
echo
echo %appcostk	%sourcetype	%source	%manatype	%noun	%tap	%maxcharge	%wearloc	%weight	$date
...
echo
echo
echo %appcostk	%sourcetype	%source	%noun	%tap	%ilsize	%iwsize	%ihsize	%csize	%volume	%wearloc	%weight	$date
