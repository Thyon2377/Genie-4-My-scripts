...
if "%force" = "not" then var force do not
echo
echo Verbose IC: These %noun are ammunition for a bow. When fired, they can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. They %force improve the force of your attacks. The %noun are %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. The %noun %force improve the force of your attacks. They are %construct.
echo
...
if "%force" = "not" then var force do not
echo
echo Verbose IC: These %noun are ammunition for a crossbow. When fired, they can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. They %force improve the force of your attacks. The %noun are %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. The %noun %force improve the force of your attacks. They are %construct.
echo
...
if "%force" = "not" then var force do not
echo
echo Verbose IC: These %noun are ammunition for a sling or staff sling. When hurled, they can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. They %force improve the force of your attacks. The %noun are %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. The %noun %force improve the force of your attacks. They are %construct.
echo
...
if "%force" = "not" then var force does not
echo
echo Verbose IC: This %noun is ammunition for a bow. When fired, it can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. It %force improves the force of your attacks. The %noun is %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. It is %construct.
echo
...
if "%force" = "not" then var force does not
echo
echo Verbose IC: This %noun is ammunition for a crossbow. When fired, it can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. The %noun is %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. It is %construct.
echo
echo OOC: Crossbow ammunition: %puncture puncture/%slice slice/%impact impact/%fire fire/%cold cold/%electric electric, %construct
pause
goto exit
...
if "%force" = "not" then var force does not
echo
echo Verbose IC: This %noun is ammunition for a sling or staff sling. When hurled, it can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. It %force improves the force of your attacks. The %noun is %construct.
echo
echo Concise IC: This ammunition can inflict %puncture puncture damage, %slice slice damage, %impact impact damage, %fire fire damage, %cold cold damage, and %electric electric damage. It is %construct.
echo
